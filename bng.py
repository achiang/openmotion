...
#
# And as per:
# Ant Beck (August 8, 2013 at 4:44 PM)
# Hi Hannah,
# 
# I’d like to re-use this code within the DART project
# (www.dartproject.info). I would like to credit you: have you released
# this under a licence or is it public domain?
# 
# Hannah Fry (Posted August 12, 2013 at 2:14 PM)
# Hi Ant,
# 
# Thank you for the message. You’re more than welcome to use the code –
# although a credit would be lovely. Best of luck with the project!
# 
#####################################################################
# The original interface name is a bit unwieldy, so I've redefined the
# module to provide tolatlng() and tolnglat().
#def OSGB36toWGS84(E,N):

from math import sqrt, pi, sin, cos, tan, atan2 as arctan2

def tolnglat(E,N):
    (lat, lng) = tolatlng(E,N)
    return (lng, lat)
